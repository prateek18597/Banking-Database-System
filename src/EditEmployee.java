...
public class EditEmployee extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(mobNoTF, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String employeeID = accNoTF.getText().trim();
        try
        {
                ...
                ResultSet rs1 = stat1.executeQuery("Select FirstName, LastName, MobNo, Address, BranchCode from Employee where EmpId =" + empId);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String branch = branchTF.getText().trim();
        try
        {
            myConn = DriverManager.getConnection(Info.url,Info.user,Info.pass);
            stat=myConn.createStatement();
            stat.executeUpdate("Update Employee set FirstName = '"+firstName+"', LastName = '"+lastName+"', MobNo = '"+mobNo+"', Address = '"+address+"',  BranchCode = '"+branch+"' where EmpId = "+empId+"");
