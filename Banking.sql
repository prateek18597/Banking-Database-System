...
CREATE TABLE `Employee` (
  ...
  PRIMARY KEY (`EmpId`),
  KEY `Manager` (`Manager`),
  CONSTRAINT `Employee_ibfk_1` FOREIGN KEY (`Manager`) REFERENCES `Employee` (`EmpId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Transaction` (
  `Id` int(11) NOT NULL,
  `FromAcc` varchar(15) NOT NULL,
  `ToAcc` varchar(15) NOT NULL,
...
-- Dump completed on 2019-04-18 19:44:16
